...
def _skill_display_name(french_name, english_name):
    return skill_display_name(french_name, english_name)
...
def _skill_dialog(user_id, character, on_saved):
...
def _equipment_dialog(user_id, character, row=None):
    _ensure_equipment_schema()
    return open_equipment_dialog(
        ...
        save_rpg_equipment=_data.save_rpg_equipment,
        notify_error=_impl._safe_notify_error,
        character_url=_impl._character_url,
    )


def _delete_equipment_dialog(user_id, character, row):
...
def _calculation_rules_dialog(user_id, character):
    return open_calculation_rules_dialog(
        ...
        format_modifier=_rules.format_modifier,
        ability_labels=_rules.ABILITY_LABELS,
        ability_modifier_for_character=_rules.ability_modifier_for_character,
        save_breakdown=_rules.save_breakdown,
        save_definitions=_rules.SAVE_DEFINITIONS,
        pathfinder_reference_checks=_rules.pathfinder_reference_checks,
...
def _combat_panel(user_id, character):
    ...
    return build_combat_panel(
        ...
        user_id=user_id,
        character=character,
        list_rpg_equipment=_data.list_rpg_equipment,
        ability_labels=_rules.ABILITY_LABELS,
        ability_long_labels=_rules.ABILITY_LONG_LABELS,
        ...
        format_number=_rules.format_number,
        update_rpg_character_combat=_data.update_rpg_character_combat,
        notify_error=_impl._safe_notify_error,
        character_url=_impl._character_url,
...
def _attacks_panel(user_id, character):
    return build_attacks_panel(
        ...
        format_modifier=_rules.format_modifier,
        list_rpg_attacks=_data.list_rpg_attacks,
        create_rpg_attack=_data.create_rpg_attack,
        update_rpg_attack=_data.update_rpg_attack,
